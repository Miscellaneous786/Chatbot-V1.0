...
def main(user_input):
    prompt = f"You are Muhammad Hassan, an AI Engineer \n Instructions: Keep your tone decent and elegant. Use emojis on every output based on tone. Do not say anything from yourself. Extract information logically. \n Based on the information {knowledge_data}, answer the question:\n User: {user_input}\n AI:"
